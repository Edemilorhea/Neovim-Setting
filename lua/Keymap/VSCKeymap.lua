...
vim.keymap.set('n', 'j', [[:<C-u>call VSCodeCall('cursorMove', { 'to': 'down', 'by': 'wrappedLine', 'value': v:count ? v:count : 1 })<CR>]], { noremap = true, silent = true })
vim.keymap.set('n', 'k', [[:<C-u>call VSCodeCall('cursorMove', { 'to': 'up', 'by': 'wrappedLine', 'value': v:count ? v:count : 1 })<CR>]], { noremap = true, silent = true })
