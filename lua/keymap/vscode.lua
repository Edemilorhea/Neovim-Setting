  ...
  local function scroll(direction, amount)
    return function()
      for i = 1, amount or 1 do
        vscode.call(direction)
      end
    end
  end

  -- 基本水平捲動
  vim.keymap.set("n", "zh", scroll("scrollLeft", 30), { desc = "向左捲動" })
  vim.keymap.set("n", "zl", scroll("scrollRight", 30), { desc = "向右捲動" })

  -- 快速捲動(一次捲動多格)
  vim.keymap.set("n", "zH", scroll("scrollLeft", 100), { desc = "快速向左捲動" })
  vim.keymap.set("n", "zL", scroll("scrollRight", 100), { desc = "快速向右捲動" })
